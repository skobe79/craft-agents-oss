 ...
 * `@arch-agentz/messaging-whatsapp-worker` subprocess.
 *
 ...
 *
 * The worker contract is defined in @arch-agentz/messaging-whatsapp-worker.
...
import {
  ...
  type WorkerCommand,
  type WorkerEvent,
} from '@arch-agentz/messaging-whatsapp-worker'
import type {
  PlatformAdapter,
  PlatformConfig,
  AdapterCapabilities,
