 ...
 * Guides are now served exclusively via the arch-agentzs-docs MCP server.
 *
 ...
 * Use the arch-agentzs-docs MCP server to search for setup guides.
 *
 * Example: mcp__arch-agentzs-docs__SearchCraftAgents({ query: "github source setup guide" })
 */
