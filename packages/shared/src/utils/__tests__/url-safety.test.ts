...
describe('classifyExternalUrl — internal deep links', () => {
  it('classifies archagentz:// as internal-deeplink', () => {
    expect(classifyExternalUrl('archagentz://settings').kind).toBe('internal-deeplink')
  })
...
describe('formatBlockedUrlError', () => {
  ...
  it('returns an empty string for non-dangerous classifications', () => {
    ...
    expect(formatBlockedUrlError(classifyExternalUrl('archagentz://settings'))).toBe('')
  })
})
...
describe('isSafeExternalUrl', () => {
  ...
  it('returns false for internal deep links', () => {
    expect(isSafeExternalUrl('archagentz://settings')).toBe(false)
  })
