 ...
 *
 * Loads release notes from bundled assets and syncs them to ~/.arch-agentz/release-notes/.
...
function loadBundledReleaseNotes(): Record<string, string> {
  ...
  // Try bundled assets first, fall back to ~/.arch-agentz/release-notes/
  // (Docker/remote server may not have ARCH_BUNDLED_ASSETS_ROOT set,
