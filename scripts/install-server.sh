...
echo ""
echo "  ARCH_SERVER_TOKEN=$TOKEN \\"
echo "  ARCH_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  ARCH_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
...
echo "  ARCH_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  ARCH_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  ARCH_RPC_HOST=0.0.0.0 \\"
echo "  ARCH_RPC_PORT=9100 \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
...
echo "  ARCH_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  ARCH_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  ARCH_RPC_TLS_CERT=/path/to/cert.pem \\"
echo "  ARCH_RPC_TLS_KEY=/path/to/key.pem \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
