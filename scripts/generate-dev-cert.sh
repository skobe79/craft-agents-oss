...
#   ARCH_RPC_TLS_CERT=certs/cert.pem ARCH_RPC_TLS_KEY=certs/key.pem bun run server:dev
...
echo "  ARCH_RPC_TLS_CERT=$OUT_DIR/cert.pem ARCH_RPC_TLS_KEY=$OUT_DIR/key.pem bun run server:dev"
