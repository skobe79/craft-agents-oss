...
<Tip>
The documents you create can also become custom agents. Write instructions in a document, and Craft Agents brings it to life. Learn more in [Skills](/skills/overview).
</Tip>
...
<Columns cols={2}>
  ...
  >
    Create custom slash commands to extend Craft Agents for your workflows.
  </Card>
  <Card
    title="Connect to anything"
    icon="link"
    href="/go-further/connect-to-anything"
  >
    Connect MCP servers, REST APIs, and local filesystems to your workspace.
  </Card>
</Columns>
