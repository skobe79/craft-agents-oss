---
title: "Themes"
description: "Customize the visual appearance with a 6-color theme system"
---
...
<AccordionGroup>
  ...
  <Accordion title="Background image not showing">
...
<AccordionGroup>
  <Accordion title="Start with just accent">
    Changing only the accent color is the quickest way to personalize the app.
  </Accordion>

  <Accordion title="Use OKLCH for predictability">
  ...
  <Accordion title="Keep contrast accessible">
