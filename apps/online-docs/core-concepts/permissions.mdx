...
│                                     │
│ I'll examine the codebase...        │
│ [Read, Grep, Glob operations run]   │
│                                     │
...
│                                     │
│ Refactoring auth components...      │
│ [All operations run automatically]  │
│                                     │
│ Updated 12 files.                   │
└─────────────────────────────────────┘
```
...
- **Dangerous commands**: Must be approved individually every time (no "always allow" option)
