...
│ Inbox                               │
├─────────────────────────────────────┤
│ ● 250121-swift-falcon    Todo       │
│   Refactoring auth module           │
│                                     │
│ ○ 250120-gentle-river    In Progress│
│   Review PR #234                    │
│                                     │
│ ✓ 250119-bright-mountain Done       │
│   Fix login bug                     │
└─────────────────────────────────────┘
```
...
For example:
- `250121-swift-falcon` - Created January 21, 2025
- `250115-gentle-river` - Created January 15, 2025
- `250108-bright-mountain` - Created January 8, 2025
...
The file format is:
- **Line 1**: Session header with metadata (id, timestamps, status, token usage)
- **Lines 2+**: Messages (one per line)

```jsonl
{"id":"260121-swift-falcon","createdAt":1737451800000,"todoState":"todo",...}
...
To start a fresh conversation, click the **New Session** button in the sidebar or use the keyboard shortcut. This creates a new session with a fresh ID while preserving your previous conversations in the inbox.
