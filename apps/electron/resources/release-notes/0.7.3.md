...
- **MCP schema conversion** — `oneOf`, `anyOf`, `allOf`, and nested objects are now correctly handled when converting MCP tool schemas, reducing "unexpected parameter" errors from providers. Partially addresses [#308](https://github.com/lukilabs/arch-agentzs-oss/issues/308) (64ae9d69)
- **Minimax preset split** — Minimax provider is now split into separate Global and CN (China) variants with correct regional endpoints. Fixes [#386](https://github.com/lukilabs/arch-agentzs-oss/issues/386) (d626f732, 5ba42ca3)
- **@file mention resolution** — file mentions in chat input are now wrapped in semantic markers so the agent can properly read and resolve them. Fixes [#293](https://github.com/lukilabs/arch-agentzs-oss/issues/293) (15d20c1d)
...
- **Title generation language awareness** — titles better reflect the language of the conversation. Partially addresses [#286](https://github.com/lukilabs/arch-agentzs-oss/issues/286) (835ea942, 1892b4c9)
