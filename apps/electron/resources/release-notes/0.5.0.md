...
- **Codex · ChatGPT Plus** — Sign in with your ChatGPT Plus or Pro subscription to use OpenAI's Codex models directly ([#2](https://github.com/lukilabs/arch-agentzs-oss/issues/2), [#44](https://github.com/lukilabs/arch-agentzs-oss/issues/44))
- **GitHub Copilot** — Connect your GitHub Copilot subscription with one-click device code authentication ([#49](https://github.com/lukilabs/arch-agentzs-oss/issues/49))
- **Google AI Studio** — Use Gemini models with your Google AI Studio API key. First-class support with native Google Search grounding built in. ([#240](https://github.com/lukilabs/arch-agentzs-oss/issues/240))
- **OpenRouter, Ollama & custom endpoints** — Bring your own API key for any OpenAI-compatible provider — OpenRouter, Ollama, or any custom endpoint ([#14](https://github.com/lukilabs/arch-agentzs-oss/issues/14), [#27](https://github.com/lukilabs/arch-agentzs-oss/issues/27))
...
- **Skill metadata** — `requiredSources` and `icon` are now displayed in the skill info page and accepted by validation ([#290](https://github.com/lukilabs/arch-agentzs-oss/issues/290), [#249](https://github.com/lukilabs/arch-agentzs-oss/issues/249))
...
- **Install scripts** — Fixed Windows and macOS/Linux install scripts to work without the version endpoint; scripts now fetch YAML manifests directly ([#273](https://github.com/lukilabs/arch-agentzs-oss/issues/273), [#276](https://github.com/lukilabs/arch-agentzs-oss/issues/276))

## Security

- **Web-fetch hardening** — Protection against SSRF, unbounded reads, and other edge cases (3904a786)
- **Explore mode** — Blocked `find -exec` and similar shell escape vectors ([#272](https://github.com/lukilabs/arch-agentzs-oss/issues/272))
