...
- **Label validation in E2E tests** — E2E test label is now created before the `set_session_labels` validation step.
- **GHCR Docker push permissions** — Added `packages:write` to workflow permissions for container registry pushes.
