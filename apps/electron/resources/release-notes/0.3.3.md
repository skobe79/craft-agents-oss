...
Configure sources that require multiple authentication headers (e.g., API key + tenant ID). See the updated documentation at `~/.arch-agentz/docs/sources.md`.
...
- Lazy loading of bundled docs fixes packaged app initialization ([arch-agentzs-oss#162](https://github.com/lukilabs/arch-agentzs-oss/issues/162))
...
| Issue | Title | Status |
|-------|-------|--------|
| [#80](https://github.com/lukilabs/arch-agentzs-oss/issues/80) | Error invoking remote method 'update:install' | Fixed |
| [#120](https://github.com/lukilabs/arch-agentzs-oss/issues/120) | Error when upgrading to newer version | Fixed |
| [#162](https://github.com/lukilabs/arch-agentzs-oss/issues/162) | Missing documentation folder after install | Fixed |
...
**Full Changelog**: [v0.3.2...v0.3.3](https://github.com/lukilabs/arch-agentzs/compare/v0.3.2...v0.3.3)
