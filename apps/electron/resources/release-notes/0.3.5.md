...
Craft Agent now supports **Claude Opus 4.6** (`claude-opus-4-6`) — Anthropic's latest and most capable model.

### What Changed

- **New top-tier model** — Opus 4.6 is OUT and now available in ARCH Agentz OS too!
...
| Issue | Title | Status |
|-------|-------|--------|
| [#73](https://github.com/lukilabs/arch-agentzs-oss/issues/73) | Auto-update | Partially addressed |
| [#127](https://github.com/lukilabs/arch-agentzs-oss/issues/127) | Google OAuth tokens not injected | Partially addressed (docs) |
...
**Full Changelog**: [v0.3.4...v0.3.5](https://github.com/lukilabs/arch-agentzs/compare/v0.3.4...v0.3.5)
