...
- Fixed Cmd+Enter sending message twice when Enter is configured as the send key (Fixes [#212](https://github.com/lukilabs/arch-agentzs-oss/issues/212), [#197](https://github.com/lukilabs/arch-agentzs-oss/issues/197))
...
- Use bun-linux-x64-baseline in CI for non-AVX2 CPU compatibility (Fixes [#218](https://github.com/lukilabs/arch-agentzs-oss/issues/218))
