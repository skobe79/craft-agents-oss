...
- Added 30-second timeout to Copilot auth model fetching to prevent infinite hang (Fixes [#228](https://github.com/lukilabs/arch-agentzs-oss/issues/228)) (c8f46f59)
...
- Added `session-mcp-server` and `bridge-mcp-server` to OSS allow list (Fixes [#226](https://github.com/lukilabs/arch-agentzs-oss/issues/226)) (101ebf99)
