...
> **CLI-first workflow (recommended):** Use `arch-agentz permission ...` commands instead of editing JSON directly.
> - `arch-agentz permission --help`
...
- Source: `~/.arch-agentz/workspaces/{slug}/sources/{source}/permissions.json`
