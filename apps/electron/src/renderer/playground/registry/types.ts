...
export type Category = 'Sources' | 'Automations' | 'Onboarding' | 'Agent Setup' | 'Chat' | 'Browser' | 'Todos' | 'Planner' | 'Session List' | 'Entity Lists' | 'Edit Popover' | 'Turn Cards' | 'TurnCard Modes' | 'Fullscreen' | 'Chat Messages' | 'Chat Inputs' | 'Toast Messages' | 'Markdown' | 'Icons' | 'Settings' | 'Feedback' | 'OAuth'
