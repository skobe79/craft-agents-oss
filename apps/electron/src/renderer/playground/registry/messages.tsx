...
// Uses shared components from @arch-agentz/ui where available
// ============================================================================
...
`} />
      ...
      {/* Section: SystemMessage (from @arch-agentz/ui) */}
      <section>
...
export const messagesComponents: ComponentEntry[] = [
  ...
  },
  {
    ...
    category: 'Chat Messages',
    description: 'Right-aligned user message bubble (from @arch-agentz/ui)',
  ...
  },
  {
    ...
    name: 'SystemMessage',
    category: 'Chat Messages',
    description: 'System/info/warning/error message (from @arch-agentz/ui)',
