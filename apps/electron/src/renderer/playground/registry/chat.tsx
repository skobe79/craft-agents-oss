...
import { TurnCard, type ActivityItem } from '@arch-agentz/ui'
...
function InputContainerPlayground({
  disabled = false,
  isProcessing = false,
  placeholder = 'Message ARCH Agent...',
  currentModel = 'claude-sonnet-4-6',
  permissionMode = 'ask',
  workingDirectory = '/Users/demo/projects/arch-agentz',
  inputMode = 'freeform',
  compactMode = false,
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        defaultValue: 'Message ARCH Agent...',
      },
      {
        name: 'currentModel',
      ...
      },
      {
        ...
        defaultValue: '/Users/demo/projects/arch-agentz',
      },
      {
        name: 'seedRecentDirs',
