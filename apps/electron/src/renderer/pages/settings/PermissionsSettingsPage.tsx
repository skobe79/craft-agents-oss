 ...
 * Shows both default patterns (from ~/.arch-agentz/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.arch-agentz/permissions/default.json.
...
import { type PermissionsConfigFile } from '@arch-agentz/shared/agent/modes'
import {
...
import { getDocUrl } from '@arch-agentz/shared/docs/doc-links'
...
/**
 * Build default permissions data from ~/.arch-agentz/permissions/default.json.
