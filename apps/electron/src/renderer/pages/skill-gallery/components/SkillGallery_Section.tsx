 ...
 * Duplicated from Info_Section to allow the gallery to evolve independently.
 */

import * as React from 'react'
import { cn } from '@/lib/utils'

export interface SkillGallery_SectionProps {
  /** Section title */
  title: string
...
export function SkillGallery_Section({
  title,
  description,
  actions,
  children,
  className,
}: SkillGallery_SectionProps) {
  return (
