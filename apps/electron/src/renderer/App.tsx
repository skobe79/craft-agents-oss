...
import type { SessionDraft, DraftAttachmentRef } from '@arch-agentz/shared/config'
...
import { TooltipProvider } from '@arch-agentz/ui'
...
import { extractWorkspaceSlugFromPath } from '@arch-agentz/shared/utils/workspace-slug'
import { DEFAULT_THINKING_LEVEL } from '@arch-agentz/shared/agent/thinking-levels'
...
export default function App() {
  ...
  useEffect(() => {
    const initialize = async () => {
      try {
        ...
        if (needs.isFullyConfigured) {
          // If no workspace is selected (thin client without ARCH_WORKSPACE_ID),
  ...
  // Platform actions for @arch-agentz/ui components (overlays, etc.)
