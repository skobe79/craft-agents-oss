...
import { usePlatform } from '@arch-agentz/ui'
...
const EDIT_CONFIGS: Record<EditContextKey, (location: string) => EditConfig> = {
  ...
  'default-permissions': (location) => ({
    context: {
      ...
      context:
        'The user is editing app-level default permissions (~/.arch-agentz/permissions/default.json). ' +
  ...
  'preferences-notes': (location) => ({
    context: {
      ...
      context:
        'The user is editing the notes field in their preferences (~/.arch-agentz/preferences.json). ' +
  ...
  'add-source': (location) => ({
    context: {
      ...
      context:
        ...
        'Follow the patterns in ~/.arch-agentz/docs/sources.md. ' +
  ...
  'add-source-local': (location) => ({
    context: {
      ...
      context:
        ...
        'First, look up the guide: mcp__arch-agentzs-docs__SearchCraftAgents({ query: "filesystem" }). ' +
  ...
  'add-skill': (location) => ({
    context: {
      ...
      context:
        ...
        'Follow the patterns in ~/.arch-agentz/docs/skills.md. ' +
  ...
  'edit-labels': (location) => ({
    context: {
      ...
      context:
        ...
        'Read ~/.arch-agentz/docs/labels.md for full format reference. ' +
        'Confirm clearly when done.',
    },
  ...
  'edit-tool-icons': (location) => ({
    context: {
      ...
      context:
        ...
        'The file is tool-icons.json in ~/.arch-agentz/tool-icons/. Icon image files live in the same directory. ' +
        ...
        'Read ~/.arch-agentz/docs/tool-icons.md for full format reference. ' +
  ...
  'automation-config': (location) => ({
    context: {
      ...
      context:
        ...
        'Read ~/.arch-agentz/docs/automations.md for full format reference. ' +
...
export function EditPopover({
  ...
  const handleLegacySendMessage = useCallback((message: string) => {
    ...
    const url = `archagentz://action/new-session?input=${encodedInput}&send=true&mode=${permissionMode}&badges=${encodedBadges}${workdirParam}${modelParam}${systemPromptParam}`
