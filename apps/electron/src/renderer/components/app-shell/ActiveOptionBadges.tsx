...
import { PERMISSION_MODE_CONFIG, type PermissionMode } from '@arch-agentz/shared/agent/modes'
...
import { flattenLabels, parseLabelEntry, formatLabelEntry, formatDisplayValue } from '@arch-agentz/shared/labels'
