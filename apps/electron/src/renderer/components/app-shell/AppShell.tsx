...
import { Tooltip, TooltipTrigger, TooltipContent, DocumentFormattedMarkdownOverlay } from "@arch-agentz/ui"
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuSub,
...
import { buildLabelTree, getDescendantIds, getLabelDisplayName, flattenLabels, extractLabelId, findLabelById, sortLabelsForDisplay } from "@arch-agentz/shared/labels"
import type { LabelConfig, LabelTreeNode } from "@arch-agentz/shared/labels"
  ...
  return (
    <AppShellProvider value={appShellContextValue}>
        ...
        <TopBar
          ...
          isNavigatorHidden={isNavigatorManuallyHidden !== null ? isNavigatorManuallyHidden : false}
      ...
      >
        <PanelStackContainer
          ...
          navigatorWidth={isAutoCompact ? sessionListWidth : (effectiveSidebarAndNavigatorHidden || (isNavigatorManuallyHidden !== null ? isNavigatorManuallyHidden : false) ? 0 : sessionListWidth)}
