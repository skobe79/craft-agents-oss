...
/**
 * AddWorkspaceStep_ConnectRemote - Connect to a remote ARCH Server
 *
 * Two paths:
...
export function AddWorkspaceStep_ConnectRemote({
  ...
  const handleConnect = useCallback(async () => {
    ...
    if (!homeDir) return
    const defaultBasePath = `${homeDir}/.arch-agentz/workspaces`
    ...
    <AddWorkspaceContainer>
      ...
      <AddWorkspaceStepHeader
        ...
        description={isReconnectMode
          ...
          : "Connect to a remote ARCH Server for this workspace."}
      />
