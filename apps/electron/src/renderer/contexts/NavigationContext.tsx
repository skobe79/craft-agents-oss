...
import { parsePermissionMode } from '@arch-agentz/shared/agent/mode-types'
...
export { isSessionsNavigation, isSourcesNavigation, isSettingsNavigation, isSkillsNavigation, isAutomationsNavigation, isAgentsNavigation }
      ...
      switch (parsed.name) {
        case 'new-session': {
          ...
          if (parsed.params.agentId) {
            createOptions.agentId = parsed.params.agentId
          }
