...
mock.module('@arch-agentz/shared/config', () => ({
...
mock.module('@arch-agentz/shared/workspaces', () => ({
  loadWorkspaceConfig: () => ({
    defaults: {
      permissionMode: 'ask',
      thinkingLevel: 'medium',
...
mock.module('@arch-agentz/shared/agent', () => ({
...
mock.module('@arch-agentz/shared/agent/backend', () => ({
...
mock.module('@arch-agentz/shared/sources', () => ({
...
mock.module('@arch-agentz/shared/automations', () => ({
...
mock.module('@arch-agentz/shared/sessions', () => ({
  listSessions: () => [],
...
const { SessionManager } = await import('@arch-agentz/server-core/sessions')
