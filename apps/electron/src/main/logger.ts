 ...
 */
export const messagingGatewayLogPath = join(homedir(), '.archstudio', 'logs', 'messaging-gateway.log')
 ...
 */
export const autoUpdateLogPath = join(homedir(), '.archstudio', 'logs', 'auto-update.log')
